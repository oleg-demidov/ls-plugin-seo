 ...
 * @since 2.0
 */
class PluginSeo_ModuleSeo_BehaviorModule extends Behavior
{
    ...
    public function CallbackGetItemsByFilterAfter($aParams)
    {
        ...
        $this->PluginSeo_Seo_RewriteGetItemsByFilter($aEntities, $this, $aFilter);
    }
    ...
    {
        $aFilter = $this->PluginSeo_Seo_RewriteFilter($aParams['aFilter'], $this, $aParams['sEntityFull']);
